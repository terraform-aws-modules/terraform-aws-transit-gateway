...
output "tgw_flow_log_destination_arn" {
  description = "The ARN of the destination for TGW Flow Logs"
  value       = local.flow_log_destination_arn
}

output "tgw_flow_log_destination_type" {
  description = "The type of the destination for TGW Flow Logs"
...
output "tgw_flow_log_deliver_cross_account_role" {
