...
output "this_ec2_transit_gateway_vpn_attachment_ids" {
  ...
  value       = module.tgw.this_ec2_transit_gateway_vpn_attachment_ids
}
...
output "transit_route_tables_map_ec2_transit_gateway_route_table_association_ids" {
  ...
  value       = module.tgw.transit_route_tables_map_ec2_transit_gateway_route_table_association_ids
}
...
output "transit_route_tables_map_ec2_transit_gateway_route_table_association" {
  ...
  value       = module.tgw.transit_route_tables_map_ec2_transit_gateway_route_table_association
}
...
output "transit_route_tables_map_ec2_transit_gateway_route_table_propagation_ids" {
  ...
  value       = module.tgw.transit_route_tables_map_ec2_transit_gateway_route_table_propagation_ids
}
...
output "transit_route_tables_map_ec2_transit_gateway_route_table_propagation" {
  ...
  value       = module.tgw.transit_route_tables_map_ec2_transit_gateway_route_table_propagation
}
