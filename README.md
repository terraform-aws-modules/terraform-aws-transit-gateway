...
| <a name="output_ec2_transit_gateway_cidr_blocks"></a> [ec2\_transit\_gateway\_cidr\_blocks](#output\_ec2\_transit\_gateway\_cidr\_blocks) | The list of associated CIDR blocks |
